...
def main():
    funds = [
        ...
        {"code": "020712", "name": "华安三菱日联日经225ETF发起式联接(QDII)A"},

        {"code": "000948", "name": "华夏沪港通恒生ETF联接A"},
        {"code": "014201", "name": "天弘中证1000指数增强A"},
        {"code": "001214", "name": "华泰柏瑞中证500ETF联接A"},
        {"code": "000051", "name": "华夏沪深300ETF联接A"},
        {"code": "022430", "name": "华夏中证A500ETF联接A"},
    ...
    if DRAW_PLOTS:
        ...
        idx = 0
        # start_dingtou_time = "2017-07-01"
        # start_dingtou_time = "2023-07-11"
        # start_dingtou_time = "2025-02-18"
        # start_dingtou_time = lastYear
        start_dingtou_time = lastTwoYear
        # start_dingtou_time = lastThreeYear
